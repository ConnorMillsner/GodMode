...
export default function ImageAnalysis({
  ...
  const getScoreExplanation = (score: number) => {
    if (score <= 15)
      return 'Significant room for improvement in all areas. Focus on basic grooming and style fundamentals.';
    if (score <= 30)
      return 'Below average presentation. Work on skincare, haircut, and overall grooming routine.';
    if (score <= 45)
      return 'Room for improvement. Update your style, improve grooming habits, and work on confidence.';
    if (score <= 60)
      return "Average presentation. You're doing okay but could elevate your style and grooming game.";
    if (score <= 75)
      return 'Above average! You have good style sense and grooming. Fine-tune the details.';
    if (score <= 90)
      return 'Excellent presentation! You have strong style and grooming. Minor optimizations only.';
          ...
          <div className={styles.imageContainer}>
            ...
            <div className={styles.scoreOverlay}>
              <div
                ...
                style={{
                  borderColor: isLoading ? '#666' : getScoreColor(score)
                }}
              >
                <span
      ...
      <div className={styles.rankingScale}>
        ...
        <div className={styles.scaleBar}>
          <div
            ...
            style={{ background: '#8B0000', flex: '15' }}
          >
          ...
          <div
            className={styles.scaleSegment}
            style={{ background: '#FF0000', flex: '15' }}
          >
            <span className={styles.scaleLabel}>
              16-30
              <br />
          ...
          <div
            className={styles.scaleSegment}
            style={{ background: '#FF4500', flex: '15' }}
          >
            <span className={styles.scaleLabel}>
              31-45
              <br />
          ...
          <div
            className={styles.scaleSegment}
            style={{ background: '#FFFF00', flex: '15' }}
          >
            <span className={styles.scaleLabel}>
              46-60
              <br />
          ...
          <div
            className={styles.scaleSegment}
            style={{ background: '#32CD32', flex: '15' }}
          >
            <span className={styles.scaleLabel}>
              61-75
              <br />
          ...
          <div
            className={styles.scaleSegment}
            style={{ background: '#0066FF', flex: '15' }}
          >
            <span className={styles.scaleLabel}>
              76-90
              <br />
          ...
          <div
            className={styles.scaleSegment}
            style={{ background: '#9400D3', flex: '10' }}
          >
            <span className={styles.scaleLabel}>
              91-100
              <br />
